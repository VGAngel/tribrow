...
public class PopupMessageState extends ObservableState {
    ...
    protected void enable() {
        ...
        Node gui = ((GuiAppState) getState(GuiAppState.class)).getOverlayRoot();
    ...
    private class ButtonCommand
        ...
        public void execute(Object source, Object action) {
            PopupMessageState.this.getStateManager().detach(PopupMessageState.this);
            if (this.cmd != null)
