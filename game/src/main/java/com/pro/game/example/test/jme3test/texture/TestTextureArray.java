...
public class TestTextureArray extends SimpleApplication {
    ...
    public void simpleInitApp() {
        Material mat = new Material(assetManager, "assets/texture/UnshadedArray.j3md");
        ...
        Texture tex1 = assetManager.loadTexture("assets/Textures/Terrain/Pond/Pond.jpg");
        Texture tex2 = assetManager.loadTexture("assets/Textures/Terrain/Rock2/rock.jpg");
