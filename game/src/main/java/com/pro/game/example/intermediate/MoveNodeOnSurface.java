package com.pro.game.example.intermediate;
...
public class MoveNodeOnSurface extends SimpleApplication {

    public static void main(String[] args) {
        MoveNodeOnSurface app = new MoveNodeOnSurface();
        app.start();
    }
    ...
    public void simpleUpdate(float tpf) {
        ...
        if (remainingDist > 0.05f && !cubechar.getWorldTranslation().equals(vecmove)) {
            ...
            if (remainingDist <= 0.02f && !cubechar.getWorldTranslation().equals(vecmove))
                cubechar.setLocalTranslation(vecmove);
        }
    }
