...
public class GateGenerator implements ChunkGenerator {

    public void generateNodes(Level l, int x, int y, SneakAroundTown app) {
        //Floor
        {
            new RoadGenerator().generateNodes(l, x, y, app);
        }
        //TOP
        {
            ...
            phy.setPhysicsLocation(new Vector3f(x * l.chunkSize + l.chunkSize * .5f, 19.5f, y * l.chunkSize + l.chunkSize * .5f));
        }
    }
}
