...
public class CastleGenerator implements ChunkGenerator {

    public void generateNodes(Level l, int x, int y, SneakAroundTown app) {
        Box b = new Box(l.chunkSize / 2, 15, l.chunkSize / 2);
        ...
        phy.setPhysicsLocation(new Vector3f(x * l.chunkSize + l.chunkSize * .5f, 15, y * l.chunkSize + l.chunkSize * .5f));
    }
}
