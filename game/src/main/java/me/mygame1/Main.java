...
import mygame1.prefabs.Asteroid;
...
public class Main extends SimpleApplication {
    ...
    public void simpleInitApp() {
        ...
        setupMainCharacter(assetManager.loadModel("assets/Models/SpaceCraft/Rocket.mesh.xml"));
        setupLightning();
        setupCamera(); //Side effect function as its invocation depends upon the order of invocation
        rootNode.attachChild(SkyFactory.createSky(assetManager, "assets/Textures/Sky/Bright/BrightSky.dds", false));
...
//        rootNode.addLight(sun1);
    ...
    private void setupEnvironment() {
        rootNode.attachChild(SkyFactory.createSky(assetManager, "assets/Textures/skybox.dds", false));
    ...
    private void placeRandomObjects(int count) {
        ...
        mat_lit.setTexture("DiffuseMap", getAssetManager().loadTexture("assets/Textures/Asteroid.jpg"));
...
//                Box box = new Box(1.5f, 1.5f, 1.5f);
    ...
    private void setupHUD() {
        ...
        watch.setImage(assetManager, "assets/Textures/hourglass.png", true);
        watch.setWidth(32f);
        watch.setHeight(32f);
        ...
        star.setImage(assetManager, "assets/Textures/stars.png", true);
        star.setWidth(32f);
        star.setHeight(32f);
...
//                System.out.println(timeLimit);
    ...
    private void setupLifes() {
        for (int i = 0; i < Level.lifes; ++i) {
            ...
            pic.setImage(assetManager, "assets/Textures/lifes.png", true);
            pic.setWidth(24f);
            pic.setHeight(24f);
    ...
    private void setupAudio() {
        collision = new AudioNode(assetManager, "assets/Sound/Effects/Gun.wav", false);
        collision.setLooping(false);
        collision.setVolume(2);
        rootNode.attachChild(collision);

        /* nature sound - keeps playing in a loop. */
        background = new AudioNode(assetManager, "assets/Sounds/Night_of_Chaos.ogg", false);
