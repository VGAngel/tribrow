...
public class BookContactResolver implements ContactResolver {

    private int maxContacts = 512;

    private int velocityIterations = this.maxContacts * 180;
    private int positionIterations = this.maxContacts * 180;

    private double velocityEpsilon = 1.E-005D;
    private double positionEpsilon = 1.0E-006D;

    public BookContactResolver() {
    }
